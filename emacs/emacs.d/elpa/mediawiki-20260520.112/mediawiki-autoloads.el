...

;;; Generated autoloads from mediawiki-oauth.el

(autoload 'mediawiki-oauth-setup-site "mediawiki-oauth" "\
...
(fn SITENAME CLIENT-ID CLIENT-SECRET &optional ACCESS-TOKEN)" t)
(autoload 'mediawiki-oauth-clear-tokens "mediawiki-oauth" "\
...
(fn SITENAME)" t)
(register-definition-prefixes "mediawiki-oauth" '("mediawiki-oauth-"))
