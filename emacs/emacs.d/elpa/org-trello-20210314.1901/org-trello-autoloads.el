...
If called interactively, enable Org-Trello mode if ARG is
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-trello-setup" '("*ORGTRELLO/MODE-PREFIX-KEYBINDING*" "*org-trello-interactive-command-binding-couples*" "org")))
