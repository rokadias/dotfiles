...
;; Package-Requires: ((json "1.2") (flycheck "20150712.903") (dash "20141201.2206") (auto-complete "1.4") (popup "0.5.1") (csharp-mode "0.8.7") (cl-lib "0.5") (s "1.10.0") (shut-up "0.3.2"))
...
(flycheck-define-generic-checker 'csharp-omnisharp-codecheck
   ...
   running in the background"
                                 ...
                                 :modes '(csharp-mode)
                                 :predicate (lambda () (and omnisharp-mode (or omnisharp--server-info omnisharp-use-http))))
