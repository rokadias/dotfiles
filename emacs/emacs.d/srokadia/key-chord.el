...
(key-chord-define-global ",." '(lambda () (interactive) (delete-other-windows) (split-window-right) (other-window 1) (ido-switch-buffer)))
(key-chord-define-global "xz" '(lambda () (interactive) (delete-other-windows) (split-window-right) (other-window 1) (ido-find-file)))
