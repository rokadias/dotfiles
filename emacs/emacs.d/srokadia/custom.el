(custom-set-variables
 ...
 '(package-selected-packages
   '(company-restclient python-pytest python-isort pyimport python-black prettier async-await yafolding lsp-mode lsp-pyright lsp-ui ox-gfm github-notifier github-review eslintd-fix js-doc prettier-js jupyter markdown-preview-eww poly-ansible poly-markdown polymode rjsx-mode docker-tramp floobits php-mode jq-mode yasnippet-snippets pyenv-mode graphviz-dot-mode ob-mermaid pivotal-tracker kubernetes-tramp mermaid-mode vue-mode protobuf-mode elpy terraform-mode cargo company-racer flycheck-rust racer rust-mode rust-playground cider clojure-mode go-scratch company-go flycheck-golangci-lint go-imports go-playground golint jss uuidgen ztree zoom-frm zenburn-theme yaml-mode xml-rpc ws-trim wiki web-mode web use-package typing-practice typing tide sx sublime-themes smex slime session scss-mode restclient react-snippets powershell-mode powershell pabbrev omnisharp nvm nodejs-repl node-resolver multiple-cursors mediawiki markdown-preview-mode magit key-chord jsx-mode json-mode js-comint ido-vertical-mode hound helm hcl-mode haskell-mode gotham-theme go-mode go-errcheck fsm fsharp-mode frame-restore flymake-go flymake flatland-theme find-file-in-repository expand-region exec-path-from-shell editorconfig-core editorconfig edit-server doremi-frm dockerfile-mode dash-at-point color-theme ack achievements ace-jump-mode))
