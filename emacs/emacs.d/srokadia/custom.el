(custom-set-variables
 ...
 '(package-selected-packages
   '(dockerfile-mode chatgpt-shell code-stats ox-clip lsp-java string-inflection jsonnet-mode jupyter ein org-jira clang-format protobuf-mode bazel lsp-mode lsp-pyright lsp-ui tree-sitter tree-sitter-langs gnu-elpa-keyring-update flymake-ruff code-review todoist auto-virtualenvwrapper urlenc ido-complete-space-or-hyphen helm "helm" python-pytest tide multiple-cursors editorconfig yasnippet-snippets async importmagic org-trello python-isort pyimport python-black prettier async-await yafolding ox-gfm github-notifier github-review eslintd-fix js-doc prettier-js markdown-preview-eww poly-ansible poly-markdown rjsx-mode floobits php-mode jq-mode pyenv-mode ob-mermaid pivotal-tracker mermaid-mode vue-mode terraform-mode company-racer flycheck-rust racer rust-playground go-scratch company-go flycheck-golangci-lint go-imports go-playground golint jss ztree zoom-frm xml-rpc ws-trim wiki web typing-practice typing sx sublime-themes smex session scss-mode restclient react-snippets powershell-mode pabbrev omnisharp nvm nodejs-repl node-resolver mediawiki markdown-preview-mode key-chord jsx-mode json-mode js-comint ido-vertical-mode hound hcl-mode gotham-theme go-mode go-errcheck fsm fsharp-mode frame-restore flymake-go flymake flatland-theme find-file-in-repository expand-region exec-path-from-shell editorconfig-core edit-server doremi-frm dash-at-point color-theme ack achievements ace-jump-mode))
